...
def run_hybrid_pipeline(payload):
    ...
    return {
        ...
        "cv": {
            ...
            "reason": "Local scene observations were evaluated by the Urban Pulse decision engine." if vision_result["detections"] else (vision_result.get("sceneReason") or "No strong visual detection available."),
            ...
            "sceneStatus": vision_result.get("sceneStatus", "not_available"),
            "threatAssessment": threat_assessment,
        },
        ...
        "aiMeta": {
            "provider": "flask",
            "engine": "hybrid-scene-threat-v5",
            "model": "sentence-transformers+florence-or-safe-fallback",
            "fallbackUsed": False,
            ...
            "sceneUnderstandingStatus": vision_result.get("sceneStatus", "not_available"),
            "sceneUnderstandingModel": vision_result.get("model", "feature-signals"),
            "machineHintIgnoredForClassification": True,
            "evaluationVersion": "ai-service-decision-engine-v5",
            "confidenceLabel": decision["confidenceLabel"],
            "reviewRequired": decision["reviewRequired"],
            "abstained": abstained,
            "conflictDetected": decision["conflictDetected"],
